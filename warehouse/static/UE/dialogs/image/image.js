    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    async: false,
                    url: 'http://api.easyapp.zhiheworld.com/file/qiniutoken',
                    data: {'module_id': 1, 'token': sessionStorage.getItem('access-token'), 'domain_type': 1, 'app_id': '7085b04d8a79c6a9'},
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                list.push({
                    src: prefix + data.key,  // data.url
                    _src: prefix + data.key, // data.url
                    title: data.title,
                    alt: data.original,
                    floatStyle: align
                });
