<template>
  <div>
    <div class="goods-header">
      <div class="goods-btn">
        <el-button type="primary" @click="addClient" size="small"><i class="el-icon-plus"></i> 添加音频</el-button>
      </div>
      ...
      <div class="goods-body">
        <el-table
            ...
            <el-table-column
              ...
              width="130">
              <template slot-scope="scope">
                <el-input v-model="input" size="mini" placeholder="序号">
                  <el-button slot="append" type="success" size="mini" icon="el-icon-check" circle></el-button>
                </el-input>
              </template>
            </el-table-column>
             <el-table-column
